...
/**
 * Fluid transfer info that empties a fluid from a potion item, but empties
 * water if its the water potion
 */
public class EmptyPotionTransfer extends EmptyFluidContainerTransfer {
  ...
  public boolean matches(ItemStack stack, FluidStack fluid) {
    ...
    return super.matches(stack, fluid)
        && (TagPreference.getPreference(MantleTags.Fluids.POTION).isPresent() || potion == Potions.WATER);
  }
