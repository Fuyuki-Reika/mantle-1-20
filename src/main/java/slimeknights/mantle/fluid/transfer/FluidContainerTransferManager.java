...
public class FluidContainerTransferManager extends SimpleJsonResourceReloadListener {
  ...
  /**
   * Checks if the given stack could possibly match, used client side to determine
   * if the fluid transfer falls back to opening the UI
   * 
  ...
  /**
   * Gets the transfer for the given item and fluid, or null if its not a valid
   * item and fluid
   */
  @Nullable
