...
/**
 * Deferred register for menu types, automatically mapping a factory argument in
 * {@link IMenuTypeExtension}
 */
...
public class MenuTypeDeferredRegister extends DeferredRegisterWrapper<MenuType<?>> {
  ...
  public <C extends AbstractContainerMenu> DeferredHolder<MenuType<C>, MenuType<C>> register(String name,
      IContainerFactory<C> factory) {
    return (DeferredHolder<MenuType<C>, MenuType<C>>) (DeferredHolder<?, ?>) register.register(name,
