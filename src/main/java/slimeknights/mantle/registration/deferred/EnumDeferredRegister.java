...
/**
 * Generic deferred register for an object using registry objects and wanting
 * enums
 */
public class EnumDeferredRegister<T> extends DeferredRegisterWrapper<T> {
  ...
  /**
   * Registers an object with multiple variants, prefixing the name with the value
   * name
   * 
   ...
   */
  public <E extends Enum<E> & StringRepresentable, I extends T> EnumObject<E, I> registerEnum(E[] values, String name,
      Function<E, ? extends I> mapper) {
    return registerEnum(values, name, (fullName, type) -> register(fullName, () -> mapper.apply(type)));
  }

  /**
   * Registers an object with multiple variants, suffixing the name with the value
   * name
   * 
   * @param values Enum values to use for this item
   * @param name   Name of the object
   ...
   * @return EnumObject mapping between different item types
   */
  public <E extends Enum<E> & StringRepresentable, I extends T> EnumObject<E, I> registerEnum(String name, E[] values,
      Function<E, ? extends I> mapper) {
