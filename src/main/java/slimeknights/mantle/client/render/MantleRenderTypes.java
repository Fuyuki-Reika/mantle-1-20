...
public class MantleRenderTypes extends RenderType {
  ...
  private MantleRenderTypes(String name, VertexFormat format, Mode mode, int bufferSize, boolean useDelegate,
  ...
  /**
   * Extension of {@link RenderType#POSITION_COLOR_TEX_LIGHTMAP_SHADER} with fog
   * information based on {@link RenderType#ENTITY_TRANSLUCENT_CULL}
   */
  public static final RenderStateShard.ShaderStateShard FLUID_SHADER = new RenderStateShard.ShaderStateShard(
      MantleShaders::getConfiguredFluidShader);
  ...
  public static final VertexFormat BLOCK_WITH_OVERLAY = VertexFormat.builder()
      .add("Position", DefaultVertexFormat.ELEMENT_POSITION)
      .add("Color", DefaultVertexFormat.ELEMENT_COLOR)
      .add("UV0", DefaultVertexFormat.ELEMENT_UV0)
      .add("UV1", DefaultVertexFormat.ELEMENT_UV1)
      .add("UV2", DefaultVertexFormat.ELEMENT_UV2)
      .add("Normal", DefaultVertexFormat.ELEMENT_NORMAL)
      .padding(4)
      .build();
