...
public class BookLoader implements ResourceManagerReloadListener {
  ...
  /**
   * Internal registry of all books for the purposes of the reloader, maps books
   * to name
   */
   ...
   * @return The class of the page type, ContentError.class if page type not
   *         registered
   */
  @Nullable
   ...
   * Be warned that the returned BookData object is not immediately populated, and
   * is instead populated when the resources are loaded/reloaded
   *
   ...
   *
   * @param id                 The ID of the book
   * @param appendIndex        Whether an index should be added to the front of
   *                           the book using a BookTransformer
   * @param appendContentTable Whether a table of contents should be added to the
   *                           front of each section using a BookTransformer
   * @param repositories       All the repositories the book will load the
   *                           sections from
   * @return The book object, not immediately populated
   */
  ...
  /**
   * Reloads all the books, called when the resource manager reloads, such as when
   * the resource pack or the language is change
   */
  @Override
