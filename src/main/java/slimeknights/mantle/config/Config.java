...
public class Config {
    ...
    /**
     * If true, enables the fluid fog fix. If false, disables it for better shader
     * compatability.
     */
    public static final BooleanValue ENABLE_FLUID_FOG_FIX;

    /** List of preferences for tag outputs */
    private static final List<String> DEFAULT_TAG_PREFERENCES = Arrays.asList("minecraft", "tconstruct", "tmechworks",
            "metalborn", "embers", "create", "immersiveengineering", "mekanism", "thermal");
