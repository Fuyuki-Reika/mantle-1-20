...
/**
 * @deprecated use {@link MantleRecipes}, ObjectHolder removed in NeoForge
 *             1.21.1
 */
...
public class MantleRecipeSerializers {
  ...
  /**
   * @deprecated use {@link MantleRecipes#CRAFTING_SHAPED_FALLBACK}, ObjectHolder
   *             removed in NeoForge 1.21.1
   */
  @Deprecated(forRemoval = true)
   ...
   *             ObjectHolder removed in NeoForge 1.21.1
   */
  @Deprecated(forRemoval = true)
