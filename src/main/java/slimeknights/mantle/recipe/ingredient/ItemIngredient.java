...
public abstract class ItemIngredient implements ICustomIngredient {
  ...
  /** Constructor with items and tag */
  ...
  public boolean test(@Nullable ItemStack stack) {
    // Check if stack matches items list or tag
  ...
  public enum ItemsField implements RecordField<List<Item>,ItemIngredient> {
    ...
    @Override
    public List<Item> get(com.google.gson.JsonObject json, TypedMap context) {
      return ITEM_LIST.getOrDefault(json, "item", List.of(), context);
    }

    @Override
    public void serialize(ItemIngredient parent, com.google.gson.JsonObject json) {
