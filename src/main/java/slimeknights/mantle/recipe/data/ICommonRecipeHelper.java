...
public interface ICommonRecipeHelper extends IRecipeHelper {
   ...
   */
  static Criterion<?> has(ItemLike item) {
    return InventoryChangeTrigger.TriggerInstance.hasItems(item);
  }

  /**
   * Creates a criterion for having items matching the predicate in inventory
   */
  static Criterion<?> inventoryTrigger(ItemPredicate... predicates) {
   ...
   */
  default void packingRecipe(RecipeOutput output, RecipeCategory category, String largeName, ItemLike large,
      String smallName, ItemLike small, String folder) {
    // ingot to block
   ...
   * @param folder    Recipe folder
   */
  default void packingRecipe(RecipeOutput output, RecipeCategory category, String largeName, ItemLike largeItem,
      String smallName, ItemLike smallItem, TagKey<Item> smallTag, String folder) {
    // ingot to block
  ...
  default void metalCrafting(RecipeOutput output, MetalItemObject metal, String folder) {
    ...
    packingRecipe(output, RecipeCategory.MISC, "ingot", ingot, "nugget", metal.getNugget(), metal.getNuggetTag(),
        folder);
  }
   ...
   */
  default void slabStairsCrafting(RecipeOutput output, BuildingBlockObject building, String folder,
      boolean addStonecutter) {
   ...
   * @param building Building object instance
   */
  default void stairSlabWallCrafting(RecipeOutput output, WallBuildingBlockObject building, String folder,
      boolean addStonecutter) {
