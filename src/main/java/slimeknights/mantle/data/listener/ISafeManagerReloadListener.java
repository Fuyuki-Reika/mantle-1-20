...
/**
 * Same as {@link ResourceManagerReloadListener}, but only runs if the mod
 * loader state is valid, used as client resource listeners can cause a
 * misleading crash report if something else throws.
 */
